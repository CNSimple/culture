...
.region-hotspot__label{fill:#f5dfb0;font:700 64px KaiTi,serif;paint-order:stroke;stroke:#081719;stroke-width:14px;stroke-linejoin:round;pointer-events:none;white-space:nowrap}
